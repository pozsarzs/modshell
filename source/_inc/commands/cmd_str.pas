    ...
    if boolisitvariable(p1)
      then
        case op of
          ...
          84: delete(vars[intisitvariable(p1)].vvalue,
                     strtointdef(s2, 0), strtointdef(s3, 0));
          85: vars[intisitvariable(p1)].vvalue :=
                inttostr(pos(s2, vars[intisitvariable(p1)].vvalue));
          86: insert(s3, vars[intisitvariable(p1)].vvalue, strtointdef(s2, 0));
          87: vars[intisitvariable(p1)].vvalue :=
                stringreplace(vars[intisitvariable(p1)].vvalue, s2, s3,
                              [rfReplaceAll]);
        else          
        end
      else
        case op of
          ...
          61: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                inttostr(length(s2));
          62: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                lowercase(s2);
          63: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                s2[strtointdef(s3, 0)];
          64: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                chr(strtointdef(s2, 0));
          65: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                inttostr(ord(s2[1]));
          76: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                inttostr(lrc(s2));
          77: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                inttostr(crc16(s2));
          83: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                concat(s2, s3);
          84: delete(arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)],
                     strtointdef(s2, 0), strtointdef(s3, 0));
          85: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                inttostr(pos(s2,
                         arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)]));
          86: insert(s3, arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)],
                     strtointdef(s2, 0));
          87: arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)] :=
                stringreplace(arrays[intisitvariablearray(p1)].aitems[intisitvariablearrayelement(p1)],
                              s2, s3, [rfReplaceAll]);
        else          
        end;
  except
